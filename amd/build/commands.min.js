...
/**
   ...
   */(Utils);_exports.getSetup=async()=>{(0,_prefetch.prefetchStrings)("tiny_ai",["toolbarbuttontitle","selectionbarbuttontitle"]);const[buttonImage,toolbarButtonTitle,selectionbarButtonTitle]=await Promise.all([(0,_utils.getButtonImage)("icon",_common.component),(0,_str.getString)("toolbarbuttontitle","tiny_ai"),(0,_str.getString)("selectionbarbuttontitle","tiny_ai")]);return editor=>{editor.ui.registry.addIcon(_common.icon,buttonImage.html),Utils.init(editor),editor.ui.registry.addButton(_common.toolbarButtonName,{icon:_common.icon,tooltip:toolbarButtonTitle,onAction:()=>{Utils.displayDialogue(_common.toolbarSource)}}),editor.ui.registry.addMenuItem(_common.toolbarButtonName,{icon:_common.icon,text:toolbarButtonTitle,onAction:()=>{Utils.displayDialogue(_common.menubarSource)}}),editor.ui.registry.addButton(_common.selectionbarButtonName,{icon:_common.icon,tooltip:selectionbarButtonTitle,onAction:()=>{Utils.displayDialogue(_common.selectionbarSource)}})}}}));
