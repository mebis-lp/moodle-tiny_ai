...
/**
   ...
   */
class _default extends _base.default{constructor(){super(...arguments),function(obj,key,value){key in obj?Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0}):obj[key]=value}(this,"getTemplateContext",(()=>{const context={modal_headline:BasedataHandler.getTinyAiString("reworkprompt"),showIcon:!0,textareatype:"prompt"};return Object.assign(context,BasedataHandler.getBackAndGenerateButtonContext()),context}))}}return _exports.default=_default,_exports.default}));
